                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${pageInfo.list }" var="user">
                        ...
                        <td>${user.username }</td>
                            ...
                            <td>
                                <a type="button"  href="${path}/user/getUser?userid=${user.userid}" class="btn btn-info btn-sm">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                    编辑</a>
                                <a type="button"  href="${path}/user/delUser?userid=${user.userid}" class="btn btn-danger btn-sm">
